      ...
      <Row>
          ...
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <Row className="mb-5">
              <Col>
                ...
                <Form.Control placeholder={"Name of custome"} rows={3} value={this.state.billTo} type="text" name="billTo" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required"/>
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <InvoiceModal showModal={this.state.isOpen} closeModal={this.closeModal} info={this.state} items={this.state.items} currency={this.state.currency} subTotal={this.state.subTotal} NonTaxableAmount={this.state.NonTaxableAmount} CGSTAmount={this.state.CGSTAmount} SGSTAmount={this.state.SGSTAmount} IGSTAmount={this.state.IGSTAmount} total={this.state.total}/>
